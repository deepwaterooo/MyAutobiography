...
function get_allinfo(doact)
{
	...
	var myAjax = new Ajax.Request(url, 
               {method: 'get',onComplete:doact,onFailure: reportError1});
...
function showad(response)
{
    ...
    var all_boards_right=rootNode.getElementsByTagName('all_boards_right')[0].firstChild.data;
    document.getElementById("all_boards_right").innerHTML=all_boards_right;
}
